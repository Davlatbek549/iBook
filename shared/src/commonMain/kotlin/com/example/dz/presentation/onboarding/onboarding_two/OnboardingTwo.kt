...
fun OnboardingScreenTwo(
    uiState: OnboardingTwoUiState = OnboardingTwoUiState(),
    onEvent: (OnboardingTwoEvent) -> Unit = {}
) {
    OnboardingScaffold(
        ...
        onButtonClick = { onEvent(OnboardingTwoEvent.NextClicked) },
        onSkipClick = { onEvent(OnboardingTwoEvent.SkipClicked) },
        hero = { ShelfHero() }
    )
}
