package com.example.ibook.app_components.popups
...
fun DeleteBooksPopup(
    ...
    @DrawableRes trashBinRes: Int = R.drawable.trash_bin
) {
    BoxWithConstraints(modifier = modifier.fillMaxSize()) {
        ...
        Column(
            ...
            DeleteBooksButton(
                text = stringResource(R.string.popup_remove_from_collection),
            ...
            DeleteBooksButton(
                text = stringResource(R.string.popup_remove_everywhere),
...
private fun DeleteBooksCard(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.popup_delete_purchased_message),
