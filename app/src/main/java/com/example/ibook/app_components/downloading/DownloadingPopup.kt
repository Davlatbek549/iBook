package com.example.ibook.app_components.downloading
...
fun DownloadingPopup(
    ...
    title: String = stringResource(R.string.reading_book_title),
    author: String = stringResource(R.string.reading_book_author),
    progress: Float = 0.25f,
    @DrawableRes coverResId: Int = R.drawable.book_cover
) {
    DownloadingPopup(
        modifier = modifier,
        title = title,
        ...
        cover = { coverModifier ->
            Image(
                ...
                contentDescription = stringResource(R.string.book_download_cover_cd),
...
fun DownloadingPopup(
    ...
    BoxWithConstraints(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.book_downloading_progress, progressPercent),
